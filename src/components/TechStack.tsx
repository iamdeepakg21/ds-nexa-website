...
export default function TechStack() {
  ...
  return (
    <section id="tech-stack" className="section" ref={ref} style={{ position: "relative", overflow: "hidden" }}>
      ...
      {/* Floating Marquee Animation - Edge to Edge */}
      <div style={{ position: "relative", padding: "2rem 0", width: "100%", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", width: "100%", gap: "1rem", overflow: "hidden", marginTop: "1rem" }}>
          <motion.div
            animate={{ x: [-2000, 0] }}
